...
Confide's hard rule: gpt-oss is the language layer, never the decision-maker. It
...
# In-memory ring buffer of recent local-model calls, surfaced in the UI's live console
