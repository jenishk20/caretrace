...
const STAGES = [
  { key: "prepare", label: "Prepare", icon: "◈", blurb: "Who's in the room, and what CareTrace already knows." },
...
function DischargeStep({ onChange, ...shared }) {
  ...
  async function discharge() {
    if (!confirm(`Discharge ${patient.name}? CareTrace will keep the full record.`)) return;
    setBusy(true);
    try {
